...
export class TrackList implements OnInit {
  ...
  ngOnInit() {
    ...
    document.body.addEventListener('mousewheel', (event: any) => this.scroll(event.wheelData));
    document.body.addEventListener('DOMMouseScroll', (event: any) => this.scroll(event.detail));
